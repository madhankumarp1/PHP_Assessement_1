...
<body>
    ...
    <section class="navbar">
        ...
        <div class="max-w-2xl mx-auto  style_add border-b-4 border-teal-500">
    ...
    <section class="1">
        <div class="div_main_sub">
            <!-- <div class="div_con_name"> -->
            <div class="blog">
                <a class="text  border-b-2 border-black text-lime-700	" cl href="/blog.php">BLOG</a>
            </div>
            <div class="prod">
                <a class="text  border-b-2 border-black	 text-lime-700 " href="/product.php">PRODUCTS STORDE</a>
            </div>
        ...
        <div class="prod1">
                <a class="text  border-b-2 border-black	 text-lime-700 " href="/user_information.php">USER INFORMATION</a>
            </div>
    </section>
