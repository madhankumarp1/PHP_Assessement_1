    ...
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <ul class="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                <li>
                    <a href="/blog.php" class="hover:underline me-4 md:me-6 text-lime-700 ">BLOG</a>
                </li>
                <li>
                    <a href="/product.php" class="hover:underline me-4 md:me-6 text-lime-700">PRODUCTS STORDE</a>
                </li>
                <li>
                    <a href="/user_information.php" class="hover:underline me-4 md:me-6 text-lime-700">USER INFORMATION </a>
                </li>
            </ul>
        </div>
